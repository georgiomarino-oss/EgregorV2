(() => {
  ...
  // tools/figma-importer/src/code.js
...
<body>
  ...
  var LEGACY_BLOCKLIST = ["prayercircle", "eventscircle", "events/room", "community/events-circle", "community/prayer-circle"];
  var FONT_STACK = [
  ...
  var LOADED_FONTS = /* @__PURE__ */ new Set();
  var BASE_FONT_REGULAR = null;
  var BASE_FONT_SEMIBOLD = null;
  ...
  function normalizeStateName(state) {
    return String(state || "default").replace(/[^a-zA-Z0-9]+/g, "_").replace(/^_+|_+$/g, "").toLowerCase();
  }
  ...
  function validateBundle(bundle) {
    ...
    const errors = [];
    const warnings = [];
    const pageOrder = safeArray((_a = bundle == null ? void 0 : bundle.manifest) == null ? void 0 : _a.figmaPageOrder);
    ...
    const screens = safeArray((_b = bundle == null ? void 0 : bundle.data) == null ? void 0 : _b.activeScreenBlueprints);
    ...
    const frameRows = safeArray((_c = bundle == null ? void 0 : bundle.data) == null ? void 0 : _c.screenFrameIndex);
    ...
    const prayerCount = safeArray((_d = bundle == null ? void 0 : bundle.data) == null ? void 0 : _d.prayerContent).length;
    const eventCount = safeArray((_e = bundle == null ? void 0 : bundle.data) == null ? void 0 : _e.eventContent).length;
    const seriesCount = safeArray((_f = bundle == null ? void 0 : bundle.data) == null ? void 0 : _f.canonicalSeries).length;
    ...
    const pageSpecs = safeArray(bundle == null ? void 0 : bundle.pageSpecs);
    ...
    const summary = {
      ...
      motionLayerRows: safeArray((_g = bundle == null ? void 0 : bundle.data) == null ? void 0 : _g.motionLayerIndex).length
    };
  ...
  function findBlueprint(bundle, route) {
    var _a;
    const screens = safeArray((_a = bundle == null ? void 0 : bundle.data) == null ? void 0 : _a.activeScreenBlueprints);
    return screens.find((s) => s.route === route) || null;
  }
  function getPageSpecText(bundle, pageName) {
    const specs = safeArray(bundle == null ? void 0 : bundle.pageSpecs);
...
${summary}`, {
  ...
  function pickSamplePrayerItems(bundle, count) {
    var _a;
    return safeArray((_a = bundle == null ? void 0 : bundle.data) == null ? void 0 : _a.prayerContent).slice(0, count);
  }
  function pickSampleEventItems(bundle, count) {
    var _a;
    return safeArray((_a = bundle == null ? void 0 : bundle.data) == null ? void 0 : _a.eventContent).slice(0, count);
  }
  function pickSampleSeriesItems(bundle, count) {
    var _a;
    return safeArray((_a = bundle == null ? void 0 : bundle.data) == null ? void 0 : _a.canonicalSeries).slice(0, count);
  }
  function pickRouteMediaSlots(bundle, pageName, route) {
    var _a;
    const rows = safeArray((_a = bundle == null ? void 0 : bundle.data) == null ? void 0 : _a.assetPlacementIndex).filter((row) => row.page === pageName);
  ...
  function sampleCardLines(bundle, pageName, route) {
    ...
    if (pageName === "Circles") {
      const statuses = safeArray((_b = (_a = bundle == null ? void 0 : bundle.data) == null ? void 0 : _a.copyStateLibrary) == null ? void 0 : _b.inviteStatuses).slice(0, 4).map((s) => `Invite status: ${s.label}`);
      return ["My Circles", "Shared With Me", "Pending Invites", ...statuses].slice(0, 4);
    }
    if (pageName === "Profile / Settings") {
      const notifications = safeArray((_d = (_c = bundle == null ? void 0 : bundle.data) == null ? void 0 : _c.copyStateLibrary) == null ? void 0 : _d.notificationPermissionStates).slice(0, 2).map((s) => `Notifications: ${s.badgeLabel}`);
      const deletion = safeArray((_f = (_e = bundle == null ? void 0 : bundle.data) == null ? void 0 : _e.copyStateLibrary) == null ? void 0 : _f.deletionStatuses).slice(0, 2).map((s) => `Deletion: ${s.badgeLabel}`);
  ...
  async function createScreenScaffold(row, blueprint, bundle, pageName) {
    ...
    await createText(frame, safeString(blueprint == null ? void 0 : blueprint.purpose, row.purpose || ""), {
      x: 16,
      y: 36,
      width: 358,
      textAutoResize: "HEIGHT",
  ...
  async function buildScreenCollectionPage(page, bundle, pageName) {
    var _a;
    const rows = safeArray((_a = bundle == null ? void 0 : bundle.data) == null ? void 0 : _a.screenFrameIndex).filter((row) => {
    ...
    for (const route of routes) {
      ...
      clusterY += 24;
      await createText(cluster, safeString(blueprint == null ? void 0 : blueprint.purpose, ""), {
        x: 16,
        y: clusterY,
        width: 398,
        textAutoResize: "HEIGHT",
  ...
  async function buildDesignSystemPage(page, bundle) {
    ...
    const cardFamily = safeArray((_a = bundle == null ? void 0 : bundle.data) == null ? void 0 : _a.componentFamilies).find((f) => f.family === "Card families");
    const cardMembers = cardFamily ? safeArray(cardFamily.members) : [];
    const liveLabels = safeArray((_c = (_b = bundle == null ? void 0 : bundle.data) == null ? void 0 : _b.copyStateLibrary) == null ? void 0 : _c.liveStatusLabels).map((x2) => `${x2.state}: ${x2.label}`);
    const inviteLabels = safeArray((_e = (_d = bundle == null ? void 0 : bundle.data) == null ? void 0 : _d.copyStateLibrary) == null ? void 0 : _e.inviteStatuses).map((x2) => `${x2.status}: ${x2.label}`);
    const blocks = [
      {
        title: "Section themes",
        lines: [...sectionThemes.map((x2) => `Theme: ${x2}`), ...routeMappings]
      },
      {
  ...
  async function buildComponentsPage(page, bundle) {
    ...
    const families = safeArray((_a = bundle == null ? void 0 : bundle.data) == null ? void 0 : _a.componentFamilies);
    let y = 130;
  ...
  async function buildStatesPage(page, bundle) {
    ...
    const stateLibrary = ((_a = bundle == null ? void 0 : bundle.data) == null ? void 0 : _a.stateLibrary) || {};
    const copyState = ((_b = bundle == null ? void 0 : bundle.data) == null ? void 0 : _b.copyStateLibrary) || {};
    const sections = [
      {
        name: "States/SharedBase",
        rows: safeArray((_c = stateLibrary == null ? void 0 : stateLibrary.sharedStates) == null ? void 0 : _c.base).map((s) => `Base state: ${s}`)
      },
      {
        name: "States/InviteLifecycle",
        rows: safeArray(copyState == null ? void 0 : copyState.inviteStatuses).map((s) => `${s.status} \u2022 ${s.label} \u2022 tone=${s.tone}`)
      },
      {
        name: "States/ReminderPermission",
        rows: [
          ...safeArray(copyState == null ? void 0 : copyState.notificationPermissionStates).map((s) => `${s.state}: ${s.title}`),
          ...safeArray(copyState == null ? void 0 : copyState.reminderStates).map((s) => `permission=${s.permissionState} reminder=${s.reminderEnabled} \u2022 ${s.detail}`)
        ]
      },
      {
        name: "States/CirclesSegments",
        rows: [
          ...safeArray((_d = stateLibrary == null ? void 0 : stateLibrary.circles) == null ? void 0 : _d.segments).map((s) => `segment=${s}`),
          ...safeArray((_e = stateLibrary == null ? void 0 : stateLibrary.circles) == null ? void 0 : _e.emptyStates).map((s) => `empty copy: ${s}`)
        ]
      },
      {
        name: "States/LiveOccurrence",
        rows: [
          ...safeArray((_f = stateLibrary == null ? void 0 : stateLibrary.live) == null ? void 0 : _f.occurrenceStates).map((s) => `occurrence=${s}`),
          ...safeArray(copyState == null ? void 0 : copyState.liveStatusLabels).map((s) => `${s.state}: ${s.label}`)
        ]
      },
      {
        name: "States/ProfileSettings",
        rows: [
          ...safeArray((_g = stateLibrary == null ? void 0 : stateLibrary.profile) == null ? void 0 : _g.notificationPermissionStates).map((s) => `notification permission=${s}`),
          ...safeArray(copyState == null ? void 0 : copyState.deletionStatuses).map((s) => `${s.badgeLabel}: ${s.headline}`),
          ...safeArray((_h = stateLibrary == null ? void 0 : stateLibrary.profile) == null ? void 0 : _h.journalSaveStates).map((s) => `journal=${s}`)
        ]
      }
    ];
    let y = 130;
  ...
  async function buildPrayerLibraryPage(page, bundle) {
    var _a;
    const prayers = safeArray((_a = bundle == null ? void 0 : bundle.data) == null ? void 0 : _a.prayerContent);
  ...
  async function createEventRow(item, prefix) {
    ...
    await createText(row, item.subtitle, { x: 208, y: 38, width: 844, textAutoResize: "HEIGHT", fontSize: 11, color: "#375679" });
    await createText(row, item.description, { x: 208, y: 58, width: 844, textAutoResize: "HEIGHT", fontSize: 11, color: "#21395A" });
    const cta = item.appCtaLabelByState ? `cta[live=${item.appCtaLabelByState.live}; waiting_room=${item.appCtaLabelByState.waiting_room}; upcoming=${item.appCtaLabelByState.upcoming}; ended=${item.appCtaLabelByState.ended}]` : `cta[live=${item.ctaLive}; waiting_room=${item.ctaWaitingRoom}; upcoming=${item.ctaUpcoming}; ended=${item.ctaEnded}]`;
  ...
  async function buildEventLibraryPage(page, bundle) {
    var _a, _b;
    const events = safeArray((_a = bundle == null ? void 0 : bundle.data) == null ? void 0 : _a.eventContent);
    const series = safeArray((_b = bundle == null ? void 0 : bundle.data) == null ? void 0 : _b.canonicalSeries);
  ...
  async function buildMotionPage(page, bundle) {
    ...
    const surfaceRows = safeArray((_a = bundle == null ? void 0 : bundle.data) == null ? void 0 : _a.motionLayerIndex);
  ...
  function createPage(name, clearExisting) {
    ...
    if (clearExisting && existing.length > 0) {
      const page2 = existing[0];
      while (page2.children.length > 0) {
        page2.children[0].remove();
      }
  ...
  async function buildFigmaFromBundle(bundle, options) {
    var _a;
    const clearExisting = !!(options == null ? void 0 : options.clearExisting);
    ...
    const targetPageNames = safeArray((_a = bundle == null ? void 0 : bundle.manifest) == null ? void 0 : _a.figmaPageOrder).slice();
    ...
    const existingPageNames = figma.root.children.filter((node) => node.type === "PAGE").map((node) => node.name);
  ...
  figma.ui.onmessage = async (msg) => {
    try {
      ...
      send("import-error", { message: (error == null ? void 0 : error.message) || String(error) });
    }
  };
})();
