  ...
  return (
    <article className="doc-shell">
      <header className="doc-header">
        <span className="kicker-pill">Privacy and Data</span>
        ...
        <div className="link-row">
          <a href={`mailto:${siteConfig.legalEmail}`} className="chip">
            Contact legal
          </a>
      ...
      <section className="policy-section">
        <h2>Summary</h2>
        <p>
          We collect only the data required to run secure accounts, power
          product functionality, and maintain reliability. This page explains
          what we collect, how it is used, and how deletion and access requests
          are handled.
        </p>
      </section>
